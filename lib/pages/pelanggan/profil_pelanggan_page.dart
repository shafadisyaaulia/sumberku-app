...
class ProfilPelangganPage extends StatefulWidget {
  ...
  @override
  State<ProfilPelangganPage> createState() => _ProfilPelangganPageState();
}
...
class _ProfilPelangganPageState extends State<ProfilPelangganPage> {
                          ...
                          child: Column(
                            children: [
                              ...
                              _buildInfoRow(Icons.location_on_outlined,
                                  'Kecamatan', '$kecamatan, Banda Aceh'),
                              Divider(
                                  height: 1,
                                  color: Colors.grey.shade200,
                                  indent: 50),
                              _buildInfoRow(
                                  Icons.home_outlined, 'Alamat', alamat),
                            ],
                          ),
                        ),
                          ...
                          child: Column(
                            children: [
                              ...
                              _buildMenuRow(
                                  ...
                                  onTap: () {}),
                              Divider(height: 1, color: Colors.grey.shade200),
                              _buildMenuRow(Icons.help_outline, 'Bantuan',
                                  onTap: () {}),
                              Divider(height: 1, color: Colors.grey.shade200),
  ...
  Widget _buildMenuRow(IconData icon, String title,
    ...
    return ListTile(
      ...
      leading: Icon(icon,
          color: isLogout ? Colors.red : Colors.grey[700], size: 22),
      title: Text(title,
          style: TextStyle(
      ...
      trailing: Icon(Icons.chevron_right,
          color: isLogout ? Colors.red : Colors.grey[400], size: 20),
      onTap: onTap,
    );
  }
}