...
class RiwayatPemilikPage extends StatelessWidget {
  const RiwayatPemilikPage({super.key});
      ...
      child: Scaffold(
        ...
        body: uid == null
            ...
            : StreamBuilder<QuerySnapshot>(
                // ✅ Query pakai index yang sudah ada: pemilikUid + createdAt
                ...
                builder: (context, snapshot) {
                  ...
                  // ✅ Filter manual di client — tidak butuh index tambahan
  ...
  Widget _buildCard(
    ...
    final String permintaanId = data['permintaanId'] ?? '';

    // ✅ Ambil langsung dari transaksi — tidak perlu FutureBuilder ke permintaan
    final String namaPelanggan = data['namaPelanggan'] ?? 'Pelanggan';
    final int jumlahAir = data['jumlahAir'] ?? 0;
    final String kecamatan = data['kecamatan'] ?? '';
              ...
              TextButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => DetailTransaksiPemilikPage(
