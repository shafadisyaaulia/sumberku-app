              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: const Text('👨🏻', style: TextStyle(fontSize: 45)), // Emoji Pemilik
                  ),
                  const SizedBox(height: 16),
                  const Text(
                    'Pak Anto', // Nama Pemilik
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        _buildInfoRow(Icons.phone_outlined, 'Nomor HP', '+62 812-9876-5432'),
                        Divider(height: 1, color: Colors.grey.shade200, indent: 50),
                        _buildInfoRow(Icons.location_on_outlined, 'Alamat Sumur', 'Jl. Sudirman No. 45, Jakarta'),
                      ],
                    ),
                  ),
